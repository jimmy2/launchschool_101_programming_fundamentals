...
def fun_with_ids
  ...
  #a_outer and #d_outer point to the same object
  ...
  1.times do
    ...
    # object_id's in the inner block are the same as what they were in the outer block.
    ...
    # object_id's have new values due to reassignment
    ...
    # inner object_id's are the same as the outer ones.
  ...
  # summary of the object id changes
  ...
  # rescue as inner variables can't be referenced from here.
end
