# 101-109 - Small Problems > Easy 6 > Cute angles

# Write a method that takes a floating point number that represents an angle 
# between 0 and 360 degrees and returns a String that represents that angle in 
# degrees, minutes and seconds. You should use a degree symbol (°) to represent 
# degrees, a single quote (') to represent minutes, and a double quote (") to represent seconds.
...
def dms(number)
  ...
  seconds = (seconds.round(2)*60).to_i
  if seconds == 60
    minutes += 1
    seconds = 0
  end
...
puts dms(361.3) # == %(360°00'00") ||  %(0°00'00")
puts dms(-76.73)
